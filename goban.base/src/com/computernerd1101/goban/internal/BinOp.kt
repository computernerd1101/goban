...
enum class BinOp: IntBinaryOperator, LongBinaryOperator {
    ...
    AND {
        ...
        override fun applyAsLong(a: Long, b: Long): Long = a and b
    },
    OR {
        override fun applyAsInt (a:  Int, b:  Int):  Int = a  or b
        override fun applyAsLong(a: Long, b: Long): Long = a  or b
    },
    XOR {
        override fun applyAsInt (a:  Int, b:  Int):  Int = a xor b
        override fun applyAsLong(a: Long, b: Long): Long = a xor b
    }
